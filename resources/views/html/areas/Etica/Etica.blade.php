        ...
        <ul class="nav-links">
            <li class="dropdown">
                ...
                <div class="dropdown-content">
                    ...
                    <a href="/ApruebaTuConocimiento/Html/Areas/Arte/Arte.html">
                        <img src="/ApruebaTuConocimiento/Assets/Iconos/Areas/arte.png" alt="Arte" class="nav-icon">Arte</a>
                    <a href="/ApruebaTuConocimiento/Html/Areas/Matematicas/matematicas.html">
                        <img src="/ApruebaTuConocimiento/Assets/Iconos/Areas/matematicas.png" alt="Matematicas" class="nav-icon">Matemáticas</a>
            ...
            <div class="right-links">
                <li><a href="/ApruebaTuConocimiento/index.php">
                    <img src="/ApruebaTuConocimiento/Assets/Iconos/Barra_Navegacion/InicioBottom.png" alt="Icono de Inicio" class="nav-icon">Inicio</a></li>
                <li><a href="/Html/Navbar/Juegos/juegos.html">
                    <img src="/ApruebaTuConocimiento/Assets/Iconos/Barra_Navegacion/Mando.png" alt="Icono de Juegos" class="nav-icon">Juegos</a></li>
                <li><a href="/Html/Navbar/Examen/examen.html">
                    <img src="/ApruebaTuConocimiento/Assets/Iconos/Barra_Navegacion/Examen.png" alt="Icono de Examen" class="nav-icon">Exámenes</a></li>
            </div>
    </nav>
    <main>
